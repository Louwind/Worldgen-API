...
public class FeatureGeneratorManager extends JsonDataLoader implements SimpleResourceReloadListener<Map<Identifier, JsonElement>> {
    ...
    private final Map<Identifier, FeatureGenerator> generators = Maps.newHashMap();
    ...
    public FeatureGenerator get(Identifier identifier) {
        return this.generators.get(identifier);
    }
