...
import github.Louwind.Features.impl.init.FeatureContextSetters;
...
public class ParameterContextSetter<T> implements FeatureContextSetter {

    protected final List<FeatureContextGetter<T>> from;
    protected final FeatureContextParameter<T> parameter;

    public ParameterContextSetter(FeatureContextParameter<T> parameter, FeatureContextGetter<T>[] from) {
    ...
    @Override
    public FeatureContextSetterType getType() {
        return FeatureContextSetters.PARAMETER;
    }

    public static class Serializer implements JsonSerializer<ParameterContextSetter> {

        @Override
        public void toJson(JsonObject json, ParameterContextSetter object, JsonSerializationContext context) {

        }

        @Override
        public ParameterContextSetter fromJson(JsonObject json, JsonDeserializationContext context) {
            ...
            return new ParameterContextSetter(parameter, from);
        }
