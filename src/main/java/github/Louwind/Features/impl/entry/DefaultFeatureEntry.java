...
public class DefaultFeatureEntry implements FeatureEntry {

	private final List<FeatureFunction> functions;
	private final List<FeatureContextSetter> setters;
	private final Identifier structureId;

	public DefaultFeatureEntry(Identifier structureId, FeatureFunction[] functions, FeatureContextSetter[] setters) {
	...
	public static class Serializer implements JsonSerializer<DefaultFeatureEntry> {

		@Override
		public void toJson(JsonObject json, DefaultFeatureEntry object, JsonSerializationContext context) {
			// TODO toJson
		}

		@Override
		public DefaultFeatureEntry fromJson(JsonObject json, JsonDeserializationContext context) {
			...
			return new DefaultFeatureEntry(structureId, functions, setters);
		}
