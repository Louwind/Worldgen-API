...
public class FeatureContextProviders {
    ...
    public static final FeatureContextProviderType THICK_TREE = new FeatureContextProviderType(new ThickTreeContextProvider.Serializer(), builder -> builder.required(BOX, CHUNK_GENERATOR, CHUNK_POS, ORIGIN, PIECES, POS, RANDOM, ROOT, ROTATION, WORLD));

    public static final FeatureContextProviderType TREE = new FeatureContextProviderType(new TreeContextProvider.Serializer(), builder -> builder.optional(HEIGHT).required(BOX, CHUNK_GENERATOR, CHUNK_POS, PIECES, POS, RANDOM, ROOT, ROTATION, WORLD));
