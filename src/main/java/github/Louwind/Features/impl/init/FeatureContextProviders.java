...
public class FeatureContextProviders {
    ...
    public static final FeatureContextProviderType PIECE = new FeatureContextProviderType(new PieceContextProvider.Serializer(), builder -> builder.optional(FeatureContextParameters.PIECE).required(BOX, CHUNK_GENERATOR, CHUNK_POS, PIECES, POS, RANDOM, ROOT, ROTATION, STRUCTURE_POOL, WORLD));
