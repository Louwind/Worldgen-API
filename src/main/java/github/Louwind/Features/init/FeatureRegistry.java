...
public class FeatureRegistry {
    ...
    public static final SimpleRegistry<FeatureContextGetterType<?>> STRUCTURE_CONTEXT_GETTER_FACTORY = new SimpleRegistry(RegistryKey.ofRegistry(new Identifier("features:getter")), Lifecycle.experimental());
    ...
    public static final SimpleRegistry<FeatureProcessorType> STRUCTURE_PROCESSOR_FACTORY = new SimpleRegistry(RegistryKey.ofRegistry(new Identifier("features:processor")), Lifecycle.experimental());
